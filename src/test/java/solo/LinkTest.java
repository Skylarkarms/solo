...
public class LinkTest {
    ...
    public static void main(String[] args) {
        ...
        Consumer<Integer> printer = Print.purple::print;

        TestUtils.POSTPONE(
                3000,
                () -> {
                    Print.green.print(TAG, "Connecting listener...");
                    integerJoin.add(printer);
                }
                ,() -> {
                    Print.green.print(TAG, "Binding...");
                    integerJoin.bind(consumer);
                    assertThat(integerSupplier, 4);
                }
                ,() -> {
                    int to = 5;
                    Print.green.print(TAG, "changing...to to " + to);
                    consumer.accept(to);
                ...
                ,() -> {
                    Print.green.print(TAG, "unbinding...");
                    integerJoin.unbind();
                ...
                ,() -> {
                    Print.green.print(TAG, "Detaching listener...");
