 ...
 *
 * */
public class JoinTestComapredToUpdate5 {
    ...
    static {
        ...
        ProfileLambdas.profile(
                TAG, LambdaProfiler.Params.custom(
                        builder ->
                                builder.setWindow(LambdaProfiler.StackWindow.all)
                                        .setPrinter(
                                                new LambdaProfiler.Interpreter.INKS(
                                                        builder1 -> {
                                                            builder1.set(
                                                                    LambdaProfiler.Interpreter.DEBUG_TYPE.timeout, Print.red::ln
                                                                    , LambdaProfiler.Interpreter.DEBUG_TYPE.delayed, Print.purple::ln
                                                                    , LambdaProfiler.Interpreter.DEBUG_TYPE.on_time, Print.green::ln
                                                            );
                                                        }
                                                )
